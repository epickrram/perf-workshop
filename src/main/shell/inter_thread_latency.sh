...
$EXEC_PREFIX $JAVA -Xmx4g -Xms4g $JVM_OPTS -Xloggc:perf-workshop-gc.log -jar ./perf-workshop-all-0.0.1.jar -i 2000 -w 100 -n 4000 -r DETAILED -r LONG | tee output.log
